...
def bt_freq_ll_ret(filename, symbol, lags, show_plot=False, show_info=False):
    ...
    # 빈 만들고
    data, cols_bin = create_bins(data, cols)
...
if __name__ == "__main__":
    ...
    symbol = "close"
    bt_freq_ll_ret(filename, symbol, lags, show_plot=more, show_info=more)
